...
namespace SimpleFPS
{
	...
	public class HealthPickup : NetworkBehaviour
	{
		...
		public bool IsAvailableForSensor => Object != null && Object.IsValid && IsActive;
		public bool IsVisibleForSensor => Object != null && Object.IsValid;

		[Networked]
		private TickTimer _activationTimer { get; set; }

		private static Collider[] _colliders = new Collider[8];
		internal static readonly System.Collections.Generic.List<HealthPickup> ActivePickups = new(64);

		private void OnEnable()
		{
			if (ActivePickups.Contains(this) == false)
